...
public class Client {
    ...
    public Client(Configuration conf) throws Exception  {
        this("com.bigo.rec.ApplicationMaster", conf);
    }
    ...
    public boolean run() throws IOException, YarnException {
        ...
        env.put(Constants.DISTRIBUTEDSHELLSCRIPTLOCATION, hdfsShellScriptLocation);
        env.put(Constants.DISTRIBUTEDSHELLSCRIPTTIMESTAMP, Long.toString(hdfsShellScriptTimestamp));
        env.put(Constants.DISTRIBUTEDSHELLSCRIPTLEN, Long.toString(hdfsShellScriptLen));
        if (domainId != null && domainId.length() > 0) {
            env.put(Constants.DISTRIBUTEDSHELLTIMELINEDOMAIN, domainId);
        }
